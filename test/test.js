describe("Something that I'm describing", 
function() {
  context("That thing under some context", 
  function() {
...
//-----------
describe("Chai Assertins Sandbox", function() {
  it("can assert true", function() {
    assert(true);
  });
  ...
  it("can assert that something is given date type", function(){
    assert.isNumber(42);
...
it("can compare two arrays that contain the same key/value pairs", function() {
